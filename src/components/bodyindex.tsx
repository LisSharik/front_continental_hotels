...
import emeraldKing1 from '../img/habhotel2.jpg';
import emeraldKing2 from '../img/habhotel3.jpg';
import emeraldKing3 from '../img/habhotel4.jpg';


const BodyIndex: React.FC = () => {
  return (
    <div className="flex flex-col">
      <div className="w-full h-[50vh] flex flex-col justify-center items-center text-center text-black bg-cover bg-center" style={{ backgroundImage: 'url("./img/img360.jpg")' }}>
      ...
      <div className="flex flex-wrap justify-center w-[90%] max-w-[1200px] my-8 mx-auto">
        <div className="w-full md:w-1/2 lg:w-1/3 p-4 box-border text-center bg-gray-100 shadow">
          ...
          <p className="text-lg mb-4">This spacious 44m² apartment features one bedroom with two beds, one bathroom, luxury linens with 400-thread-count sheets, Loccitane amenities, a living room, a full kitchen and a 4K television with DirecTV.</p>
