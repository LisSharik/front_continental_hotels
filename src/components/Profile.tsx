    ...
    <div className="bg-white rounded-lg shadow-lg p-6 w-full h-full max-w-4xl mx-auto flex items-start space-x-8">
      ...
      <div className="w-full">
        <div className="flex space-x-4 mb-4">
          <div className="w-1/2">
            <label htmlFor="first-name" className="block font-bold mb-1">Name:</label>
            <input type="text" id="first-name" placeholder="Ingrese su nombre" className="w-full p-2 border border-gray-300 rounded" />
          </div>
          <div className="w-1/2">
            <label htmlFor="last-name" className="block font-bold mb-1">Lastname:</label>
        ...
        <div className="flex space-x-4 mb-4">
          ...
          <div className="w-1/2">
            <label htmlFor="mobile" className="block font-bold mb-1">Phone Number:</label>
